...
export const projects: Project[] = [
  ...
  {
    title: "Royal Tap E-Commerce",
    description: "Custom e-commerce solution built for a UK business with payment gateway integration, full mobile responsiveness, and SEO optimisation. Achieved a 90+ Google PageSpeed score.",
    problem: "The client needed a performant online store that could handle payments securely without relying on expensive SaaS platforms.",
    result: "Delivered an end-to-end e-commerce site with integrated payments, 90+ PageSpeed score, and full SEO configuration — handling real transactions in production.",
    tech: ["WordPress", "Custom PHP", "WooCommerce", "SEO"],
    icon: <Globe className="w-8 h-8" />,
  ...
  {
    title: "Shuttercraft Boats",
    description: "Full-stack business website with a content management system and customer inquiry workflow. Includes RESTful API endpoints, database schema design, and server-side form validation with automated email notifications.",
    problem: "The business had no online presence and was relying entirely on word-of-mouth for customer inquiries.",
    result: "Built a professional site with a CMS for self-service content updates and an automated inquiry system that routes customer requests directly via email.",
    tech: ["Laravel", "MySQL", "REST API", "PHP"],
    icon: <Globe className="w-8 h-8" />,
    github: "https://github.com/moqayyubok",
    demo: "https://shuttercraft.boats",
    featured: true,
  },
  {
    title: "Retro App",
